...
public class PathSplineEndlessCS : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        carIter += carAdd * Time.deltaTime * CarSpeed;

        if (trackTrailRenderers != null)
        ...
        if (Input.anyKeyDown)
        {
            ...
            LeanTween.moveLocalX(carInternal, (trackIter - 1) * 6f, CarSpeed).setEase(LeanTweenType.easeOutBack);
        }
    }
